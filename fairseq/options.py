...
def add_checkpoint_args(parser):
    ...
    # fmt: off
    #Edit: them action, thay metavar = dest
    group.add_argument('--save-dir', dest='DIR', default='checkpoints', action='store_true',
...
def add_model_args(parser):
    ...
    group.add_argument('--criterion', default='cross_entropy', metavar='CRIT',choices=CRITERION_REGISTRY.keys(),help='Training Criterion')
    # fmt: on
    return group
