...
def batch_by_size(
    ...
    for idx in indices:
        ...
        # Edit:
        str_assert = "sentence at index {} exceeds max_tokens limit!".format(idx)
        assert sample_len <= max_tokens, str_assert
        #
...
# Edit: def process_bpe_symbol(sentence:str, bpe_symbol:str):
def process_bpe_symbol(sentence, bpe_symbol):
