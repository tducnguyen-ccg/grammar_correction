...
class progress_bar(object):
    ...
    #Edit: print -> _print
    def _print(self, stats, tag='', step=None):
    ...
    def __iter__(self):
        ...
        for i, obj in enumerate(self.iterable):
            ...
            if self.stats is not None and i > 0 and \
                ...
                #Edit
                print('{}:  {:5d} / {:d} {}'.format(self.prefix, i, size, postfix,flush=True))
...
class tensorboard_log_wrapper(progress_bar):
    ...
    def _print(self, stats, tag='', step=None):
        ...
        self._log_to_tensorboard(stats, tag, step)
        #Edit: print -> _print
        self.wrapped_bar._print(stats, tag=tag, step=step)
