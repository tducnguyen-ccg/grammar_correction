...
# Edit: from fairseq import optim, utils
import fairseq.optim
from fairseq.optim import fairseq_optimizer
...
# Edit: class FP16Optimizer(optim.FairseqOptimizer):
class FP16Optimizer(fairseq_optimizer.FairseqOptimizer):
    """
...
# Edit: class MemoryEfficientFP16Optimizer(optim.FairseqOptimizer):
class MemoryEfficientFP16Optimizer(fairseq_optimizer.FairseqOptimizer):
    """
    Wrap an *optimizer* to support FP16 (mixed precision) training.
